    ...
    "dist/kb_explorer.js"(exports) {
      ...
      var RosKBClient = class {
        constructor(rosBridgeUrl) {
          ...
          this.active_concepts_sub = new import_roslib.default.Topic({
            ros: this.ros,
        ...
        on_active_concepts(callback) {
          this.active_concepts_sub.subscribe((message) => {
            callback(message);
          });
        }
      };
      var ros_kb_client = new RosKBClient(`ws://${location.hostname}:9090`);
        ...
        static fromKB(term) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!response || !response["json"]) {
              ...
              return new _Node(term, "undecided");
            }
